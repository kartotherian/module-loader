...
YamlLoader.prototype.update = function update(yamlData, yamlFile) {
    let self = this,
        opts = self._opts;
    if (!opts.yamlSetAttrs && !opts.yamlSetParams && !opts.yamlLayers &&
    ...
    // TODO: implement yamlSetAttrs, yamlSetParams, yamlLayers, yamlExceptLayers
